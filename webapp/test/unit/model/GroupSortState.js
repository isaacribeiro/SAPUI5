sap.ui.define([
		"appl/sapui5/isaac/model/GroupSortState",
	...
	QUnit.test("Should always return a sorter when sorting", function (assert) {
		...
		assert.strictEqual(this.oGroupSortState.sort("ContactName").length, 1, "The sorting by ContactName returned a sorter");
	});
	...
	QUnit.test("Should set the grouping to None if the user sorts by ContactName and there was a grouping before", function (assert) {
		// Arrange
		this.oModel.setProperty("/groupBy", "");

		this.oGroupSortState.sort("ContactName");
