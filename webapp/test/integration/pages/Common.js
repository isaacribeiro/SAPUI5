sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("appl/sapui5/isaac/app", ".html");
			sHash = sHash || "";
			sUrlParameters = sUrlParameters ? "?" + sUrlParameters : "";

			if (sHash) {
				sHash = "#NorthwindApplication-display&/" + (sHash.indexOf("/") === 0 ? sHash.substring(1) : sHash);
			} else {
				sHash = "#NorthwindApplication-display";
			}

			return sUrl + sUrlParameters + sHash;
		}

		return Opa5.extend("appl.sapui5.isaac.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["appl/sapui5/isaac/localService/mockserver"], function (mockserver) {
