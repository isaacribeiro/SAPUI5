sap.ui.define([
	...
	return BaseObject.extend("appl.sapui5.isaac.model.GroupSortState", {
		 ...
		 * @alias appl.sapui5.isaac.model.GroupSortState
		 */
		...
		group: function (sKey) {
			...
			if (sKey === "") {
				...
				this._oViewModel.setProperty("/sortBy", "ContactName");
			}
